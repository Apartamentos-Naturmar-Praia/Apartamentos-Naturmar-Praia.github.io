...
const pricesTable = {
  dates: [
    ...
    {start: "2024-03-01", end: "2024-03-22"},
    {start: "2024-03-23", end: "2024-03-31"},
    {start: "2024-04-01", end: "2024-04-30"},
    {start: "2024-05-01", end: "2024-05-31"},
    {start: "2024-06-01", end: "2024-06-15"}, {start: "2024-06-16", end: "2024-06-30"},
    {start: "2024-07-01", end: "2024-07-15"}, {start: "2024-07-16", end: "2024-07-31"},
    {start: "2024-08-01", end: "2024-08-31"},
    {start: "2024-09-02", end: "2024-09-15"}, {start: "2024-09-16", end: "2024-09-30"},
    {start: "2024-10-01", end: "2024-10-31"},
    {start: "2024-11-01", end: "2024-12-28"},
  ],
  prices: {
    "T0":   [40, 45, 60, 45, 50, 60,  70,  80, 100, 110,  90,  65, 50, 40],
    "T0S":  [45, 50, 65, 50, 55, 65,  75,  85, 110, 120, 100,  75, 55, 45],
    "T0+1": [50, 55, 70, 55, 60, 70,  80,  90, 115, 130, 105,  80, 60, 50],
    "T0+2": [55, 60, 75, 60, 65, 75,  85,  95, 120, 140, 110,  85, 65, 55],
    "T1":   [60, 65, 80, 65, 70, 80,  90, 100, 130, 150, 115,  90, 70, 60],
    "T1S":  [65, 70, 85, 70, 75, 85,  95, 110, 140, 160, 120,  95, 75, 65],
    "T2":   [70, 75, 95, 75, 80, 95, 105, 125, 165, 185, 130, 100, 80, 70]
...
for(const src of slidesTable["T0"].slides) {
  new Image().src = src;
}
...
const changeSlide = id => {
  ...
  preloader.src = slides[slideIndex];
